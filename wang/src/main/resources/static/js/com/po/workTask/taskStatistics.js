...
//		}
//	},
	{mData: "notReceiveTask",mRender : function(mData, type, full){
		return taskSta.getTaskLink(full.directorId,"0","0",mData);
		}
	},
	{mData: "receiveTask",mRender : function(mData, type, full){
		return taskSta.getTaskLink(full.directorId,"1","0",mData);
	}},
	{mData: "remindersTask",mRender : function(mData, type, full){
		if(mData>0){
			var temp="'"+full.taskIds+"'";
			return taskSta.getTaskLink(full.directorId,temp,"1",mData);
		}else{
			return 0;
		}
	}},
	{mData: "extensionTask",mRender : function(mData, type, full){
		return taskSta.getTaskLink(full.directorId,"2","0",mData);
	}},
	{mData: "extendedTask",mRender : function(mData, type, full){
		return taskSta.getTaskLink(full.directorId,"6","0",mData);
	}},
	{mData: "finishedTask",mRender : function(mData, type, full){
		var t="'"+full.finTaskIds+"'";
		if(mData>0){
			return '<a href="#" onclick="taskSta.getWorkTaskFi('+full.directorId+','+t+',2)">'+mData+'</a>';
		}else{
			return mData;
		}
	}}
