	            ...
	            <tbody>
		            <tr>
						...
						<td>
					 		 ...
					 		 <input type="hidden" id="extStr1" name = "extStr1" value="1"/>
						</td>
						<td>联系人</td>
						 <td>
...
<h2 class="panel-heading clearfix">离职/之前人员联系信息</h2>
...
<script src='${sysPath}/js/com/shyt/customerPeople/NocustomerPeople.js'></script>
