...
//设置每行按钮
 function oTableSetButtones (source) {
	...
	var del = "<a class=\"a-icon i-remove m-r-xs\" href=\"#\" onclick=\"visit.deleteVisit("+ source.id+")\" style=\"padding:1px 4px;\">删除</a>";
	return read+del ;
}; 
</script>
...
<script src='${sysPath}/js/com/shyt/visit/visit.js'></script>
