...
<script src="${sysPath}/js/com/po/plan/weekPlanAnno.js"></script>
	    	...
	    	<section class="tree-fluid m-t-md">
		        <aside class="tree-wrap" id="LeftHeight_box" style="width:140px;">
		           <section class="panel" id="LeftHeight" style="width:140px;">
		               <div id="weeksSpanDiv" class="table-wrap notation-btn">
		                   <table id="weeksSpanTable" class="table first-td-tc">
		                       <thead id="header_2">
		                           <tr>
		                               <th>
