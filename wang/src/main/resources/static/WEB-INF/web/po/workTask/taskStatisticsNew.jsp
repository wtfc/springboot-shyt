...
<section class="scrollable padder jcGOA-section" id="scrollable">
    ...
    <div class="search-line hide">
      ...
      <form class="table-wrap form-table" id="taskTotal">
          <input type="hidden" id="startTimeTemp" name="startTimeTemp"/>
      	 ...
      	 <input type="hidden" id="createUserOrg" name="createUserOrg" value="${userOrgId}"/>
 ...
 <!--end 任务统计 弹出层-->
<script src="${sysPath}/js/com/po/workTask/taskStatisticsNew.js" type="text/javascript"></script>
