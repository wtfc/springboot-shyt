...
<script type="text/javascript"
	src='${sysPath}/js/lib/jquery/jquery-1.10.2.js'></script>
<style type="text/css">
.panel .table input[type="text"],.panel .table select.select-mini {
	width: 60px;
	margin: 0 10px;
}

.panel .table input[type="text"],.panel .table select.select-mini2 {
	width: 100px;
	margin: 0 10px;
}

.panel .calendar .table>tbody>tr>td {
	vertical-align: top;
	border-top: none;
}

.panel .calendar-heading tr td {
	border-top: none;
}
...
.panel .calendar-heading .btn.dark {
...
.panel .calendar-heading .btn.page {
	background-color: #0063a6;
	border-color: #00497b;
	color: #fff;
}

.panel .calendar-heading .btn.dark:focus,.form-btn .btn.dark:hover,.panel .calendar-heading .btn.page:focus,.form-btn .btn.page:hover
	{
...
<body>
	<section class="scrollable padder" id="scrollable">
		<header class="con-header pull-in" id="header_1">
			<h1>万年历</h1>
			<div class="crumbs">
				<a href="#" onclick="window.parent.location.reload();">首页</a><i></i>个人办公<i></i>工具箱<i></i>万年历
			</div> 
		</header>
		<section class="tree-fluid m-t-md">
			<section class="tree-right">
				<section class="panel">
					<form name="CLD" class="table-wrap form-table calendar">
						<table class="table">
							<tr>
								<td>
									<table style="width:100%;">
										<tr>
											<td colspan="7">
												<table style="width:100%;" class="calendar-heading form-btn">
													<tr>
														<td style="width:15%;text-align:left;"><a href="#"
															onclick="pushBtm('YU')" class="btn page"><i
																class="fa fa-backward icon"></i></a> <a href="#"
															onclick="pushBtm('MU')" class="btn page"><i
																class="fa fa-caret-left icon"></i></a></td>
														<td style="width:70%;text-align:center;"><font
															style="font-size:10pt"> 公历 <select
																onchange="changeCld()" name="SY" class="select-mini2">
																	<script>
                                    ...
                                    for (i = 1; i < 13; i++) document.write('<option>' + i)
														...
														</font> <font id="GZ" style="font-size:10pt"></font> <input
															class="btn dark" type="button" onclick="pushBtm('')"
															value="今日"></td>
														<td style="width:15%;text-align:right;"><a href="#"
															onclick="pushBtm('MD')" class="btn page"><i
																class="fa fa-caret-right icon"></i></a> <a href="#"
															onclick="pushBtm('YD')" class="btn page"><i
																class="fa fa-forward icon"></i></a></td>
													</tr>
												</table>
											</td>
										</tr>
										...
										<tr>
											<td style="width:14%;text-align:center;"><font
												style="color:#fb6b5b"><b>日</b></font></td>
											<td style="width:14%;text-align:center;"><b>一</b></td>
											<td style="width:14%;text-align:center;"><b>二</b></td>
											<td style="width:14%;text-align:center;"><b>三</b></td>
											<td style="width:14%;text-align:center;"><b>四</b></td>
											<td style="width:14%;text-align:center;"><b>五</b></td>
											<td style="width:14%;text-align:center;"><font
												color="green"> <b>六</b>
											</font></td>
										</tr>
                ...
                for (i = 0; i < 6; i++) {
                    ...
                    for (j = 0; j < 7; j++) {
                        gNum = i * 7 + j
                        document.write('<td id="GD' + gNum + '" onmouseenter="mOvr(' + gNum + ')" onmouseleave="mOut()"  style="width:14%;text-align:center;"><font id="SD' + gNum + '" size="4" face="Arial Black"')
                        if (j == 0) document.write(' color=#fb6b5b')
										...
										<tr>
											<td colspan="7" style="padding:0;">
												<table width="100%" style="text-align:center;">
													<tr>
														<td id="ST" colspan="7" style="border-top:none;">
															&nbsp;</td>
														<td colspan="2" id="dayglu0"
															style="color:#fb6b5b;text-align:center;">&nbsp;</td>
														<td colspan="2" id="dayglu1"
															style="color:#fb6b5b;text-align:center;">&nbsp;</td>
														<td colspan="2" id="dayglu2"
															style="color:#fb6b5b;text-align:center;">&nbsp;</td>
													</tr>
													<tr>
														<td style="text-align:left;">日辰 <font
															style="color:#fb6b5b">吉</font> <font
															style="color:#0000A0">凶</font>：
														</td>
														<td id="RC0" style="color:#fb6b5b;text-align:left;">
															青龙</td>
														<td id="RC1" style="color:#fb6b5b;text-align:left;">
															明堂</td>
														<td id="RC2" style="color:blue;text-align:left;">天刑</td>
														<td id="RC3" style="color:blue;text-align:left;">朱雀</td>
														<td id="RC4" style="color:#fb6b5b;text-align:left;">
															金匮</td>
														<td id="RC5" style="color:#fb6b5b;text-align:left;">
															天德</td>
														<td id="RC6" style="color:blue;text-align:left;">白虎</td>
														<td id="RC7" style="color:#fb6b5b;text-align:left;">
															玉堂</td>
														<td id="RC8" style="color:blue;text-align:left;">天牢</td>
														<td id="RC9" style="color:blue;text-align:left;">玄武</td>
														<td id="RC10" style="color:#fb6b5b;text-align:left;">
															司命</td>
														<td id="RC11" style="color:blue;text-align:left;">勾陈
														</td>
													</tr>
													<tr>
														<td colspan="13"
															style="height:1px;background:#999;padding:0;"></td>
													</tr>
													<tr>
														<td id="SC12" align="right" style="width:14%;height:24px">
														</td>
														<script>
                            for (i = 0; i < 12; i++) {
                                document.write('<td id="SC' + i + '" width="7%" onMouseOver="stopCount(' + i + ')" onMouseOut="tick()" style="cursor:pointer;text-align:left;"></td>')
                            }
                        </script>
													</tr>
													`
													<tr>
														<td style="height:2px;padding:0;"></td>
														<script>
                            for (i = 0; i < 12; i++) {
                                document.write('<td id="STG' + i + '"></td>')
													...
													<tr>
														<td>时辰 <font style="color:#fb6b5b">吉</font> <font
															style="color:#0000A0">凶</font>：
														</td>
														<script>
                            for (i = 0; i < 12; i++) {
                                document.write('<td id="SJ' + i + '" width="7%" onMouseOver="stopCount(' + i + ')" onMouseOut="tick()" style="cursor:pointer;"></td>')
													...
													<tr>
														<td height="24px">&nbsp;</td>
														<td id="SJS9"></td>
														<td id="SJS10" colspan="2" style="text-align:left;">
														</td>
														<td id="SJS11"></td>
														<td id="SJS12" colspan="2" style="text-align:left;">
														</td>
														<td id="SJS13"></td>
														<td id="SJS14" colspan="2" style="text-align:left;">
														</td>
														<td id="SJS15"></td>
														<td id="SJS16" colspan="2" style="text-align:left;">
														</td>
													</tr>
												</table>
											</td>
								...
								<td style="border-top:none;width:300px;">
									<table>
										<tr>
											<td
												style="border-top:none;background:#004e87;color:#fff;text-align:center;"
												id="rymdw"></td>
										</tr>
										<tr>
											<td style="padding:0;border-top:none;">
												<table style="width:100%;background:#0163aa;">
													<tr>
														<td id="rfromtd"
															style="font-size:13px;border-top:none;color:#fff;text-align:center;background:none;">
														</td>
													</tr>
													<tr style="height:60px;">
														<td id="rdate" style="text-align:center;border-top:none;">
														</td>
													</tr>
													<tr>
														<td id="rnlw"
															style="height:22px;color:#fff;text-align:center;border-top:none;">
														</td>
													</tr>
													<tr>
														<td id="rjzn"
										...
										<tr>
											<td
												style="color:#FFF;background:#00a853;height:22px;text-align:center;border-top:none;">
												<span style="font-size:14px; color:#FF0;">【现在】</span> <span
												id="rtime1" style="font-size:15px;"></span> <span
												id="rtime2" style="font-size:14px;"></span>
											</td>
										</tr>
										<tr>
											<td id="rjryj" style="height:80px;padding:0;border-top:0;">
											</td>
										</tr>
										<tr>
											<td id="rjy"
												style="line-height:20px;height:44px;text-align:center;border-top:none;">
											</td>
										</tr>
										<tr>
											<td style="line-height:24px; text-indent:2em;">阳历中 <font
												style="color:#fb6b5b">红色</font>/ <font style="color:green">绿色</font>表示节假日，节日中
												<font style="color:green">绿色</font>表示为24节气日， <font
												style="color:#fb6b5b">红色</font>表示为农历节日， <font
												style="color:blue">蓝色</font>则表示为公历节日。
											</td>
										</tr>
										<tr>
											<td style="border-top:none;padding:0;">
												<table style="width:100%;text-align:center;">
													<tr>
														<td style="width:50%;"><font color="#fb6b5b">青龙：消息吉。</font>
														</td>
														<td style="width:50%"><font style="color:#fb6b5b">明堂：吉。</font>
														</td>
													</tr>
													<tr>
														<td><font style="color:#fb6b5b">金匮：财星吉。</font></td>
														<td><font style="color:#fb6b5b">天德：官贵吉。</font></td>
													</tr>
													<tr>
														<td><font style="color:#fb6b5b">玉堂：吉。</font></td>
														<td><font style="color:#fb6b5b">司命：官长吉。</font></td>
													</tr>
													<tr>
														<td>天刑：驿马强动。</td>
														<td>朱雀：口舌。</td>
	...
	<script>
		...
		**/
        ...
        var yj0 = '<font style="background-color:#02abec; color:#FFF">&nbsp;宜&nbsp;</font>&nbsp;';
        var yj1 = '<font style="background-color:#fe6150; color:#FFF">&nbsp;忌&nbsp;</font>&nbsp;';

        var sk = new Array(
            '子时', '一刻', '凶。', '二刻', '平。平。', '三刻', '吉。旺财丁。', '四刻', '吉。旺财丁。', '五刻', '吉。旺人丁。', '六刻', '平。平。', '七刻', '凶。', '八刻', '凶。',
            '丑时', '一刻', '凶。', '二刻', '凶。', '三刻', '吉。生贵子。', '四刻', '吉。吉利。', '五刻', '吉。大吉利。', '六刻', '凶。', '七刻', '凶。', '八刻', '凶。',
            '寅时', '一刻', '凶。', '二刻', '吉。旺子孙。', '三刻', '吉。发大财。', '四刻', '凶。', '五刻', '吉。旺人丁。', '六刻', '吉。旺人丁。', '七刻', '凶。', '八刻', '凶。', '卯时', '一刻', '吉。发福吉。', '二刻', '凶。', '三刻', '凶。', '四刻', '吉。吉利。', '五刻', '凶。', '六刻', '吉。发人丁。', '七刻', '吉。吉利。', '八刻', '吉。发横财。',
		...
		**/
        ...
        function calendar(y, m) {
            ...
            for (var i = 0; i < this.length; i++) {
                ...
                this[i].xsfw = '<font style="color:#444">\u25C7喜神：</font>' + xs;
                this[i].fsfw = '<font style="color:#444">\u25C7福神：</font>' + fs;
                this[i].csfw = '<font style="color:#444">\u25C7财神：</font>' + cs;
            }
            //节气
            tmp1 = sTerm(y, m * 2) - 1;
            ...
            if (m == 3) this[tmp1].color = '#fb6b5b'; //清明颜色
            //公历节日
            for (i in sFtv)
                if (sFtv[i].match(/^(\d{2})(\d{2})([\s\*])(.+)$/))
                    if (Number(RegExp.$1) == (m + 1)) {
                        this[Number(RegExp.$2) - 1].solarFestival += RegExp.$4 + ' ';
                        if (RegExp.$3 == '*') this[Number(RegExp.$2) - 1].color = '#fb6b5b';
                    }
                    //月周节日
            for (i in wFtv)
                ...
                if (lFtv[i].match(/^(\d{2})(.{2})([\s\*])(.+)$/)) {
                    ...
                    if (tmp1 >= 0 && tmp1 < n) {
                        ...
                        if (tmp2 >= 0 && tmp2 < this.length && this[tmp2].isLeap != true) {
                            ...
                            if (RegExp.$3 == '*') this[tmp2].color = '#fb6b5b';
                        }
                    }
                }
                //复活节只出现在3或4月
        ...
        function drawCld(SY, SM) {
            ...
            if (SY > 1874 && SY < 1909) yDisplay = '<font style="color:#fe6152;margin:0 10px;">光绪' + (((SY - 1874) == 1) ? '元' : SY - 1874);
            if (SY > 1908 && SY < 1912) yDisplay = '<font style="color:#fe6152;margin:0 10px;">宣统' + (((SY - 1908) == 1) ? '元' : SY - 1908);
            if (SY > 1911 && SY < 1950) yDisplay = '<font style="color:#fe6152;margin:0 10px;">民国' + (((SY - 1911) == 1) ? '元' : SY - 1911);
            if (SY > 1949) yDisplay = '<font style="color:#fe6152;margin:0 10px;"> 建国' + (((SY - 1949) == 1) ? '元' : SY - 1949);
            ...
            for (i = 0; i < 42; i++) {
                ...
                if (sD > -1 && sD < cld.length) { //日期内
                    ...
                    if (cld[sD].isToday) {
                        ...
                        //节日
                        TFestival.innerHTML = '<font>【今天节日】</font> &nbsp;<font style="color:#00ff">' + cld[sD].solarTerms + '</font> &nbsp;<font style="color:#00ffff">' + cld[sD].solarFestival + '</font> &nbsp;<font style="color:#ff9966">' + cld[sD].lunarFestival + "</font>";
                        //宜忌
                        if (cld[sD].sgz5 != 0) {
                            jyt = cld[sD].sgz5;
                            jyt1 = cld[sD].sgz5;
                        ...
                        Ntd.innerHTML = '<font style="color:#444">【今日宜忌】</font> ' + jyt;
                        //日辰
                        ...
                        rfromtd.innerHTML = '距离今天&nbsp;&nbsp;<font style="color:#fff">0</font>&nbsp;&nbsp;天';
                        rfromtdT = rfromtd.innerHTML;
                        rdate.innerHTML = '<font style="font-size:48px;color:#fff;display:block;font-weight:blod;height:48px;line-height:48px;font-family:Arial Black">' + cld[sD].sDay + '</font>';
                        ...
                        setInterval(function() {
                            with(new Date) document.getElementById("rtime1").innerHTML = (getHours() < 10 ? ('0' + getHours()) : getHours()) + ':' + (getMinutes() < 10 ? ('0' + getMinutes()) : getMinutes()) + ':' + (getSeconds() < 10 ? ('0' + getSeconds()) : getSeconds())
                        }, 1000)
                        setInterval(function() {
                            with(new Date) document.getElementById("rtime2").innerHTML = '（' + '子丑丑寅寅卯卯辰辰巳巳午午未未申申酉酉戌戌亥亥子'.charAt(getHours()) + '时' + (getHours() % 2 == 0 ? '五六七八' : '一二三四').charAt(parseInt(getMinutes() / 15)) + '刻）'
                        }, 1000)
                        rjryj.innerHTML = '<table width="100%"><tr><td rowspan="3" style="width:30px;text-align;center;background:#ee952d;border-top:none;"><font style="color:#fff">节<br><br>日</font></td><td style="height:36px;background:#ee952d;border-top:none;"><font style="color:#fff">&nbsp;&nbsp;' + cld[sD].solarFestival + '</font></td></tr><tr><td style="height:22px;background:#ee952d;border-top:none;"><font style="color:#fff">&nbsp;&nbsp;' + cld[sD].lunarFestival + '</font></td></tr><tr><td style="height:22px;background:#ee952d;border-top:none;"><font style="color:#fff">&nbsp;&nbsp;' + cld[sD].solarTerms + '</font></td></tr></table>';
                    ...
                    if (s.length > 0) { //农历节日
                        ...
                        s = s.fontcolor('#fb6b5b');
                    } else { //公历节日
                        s = cld[sD].solarFestival;
                        if (s.length > 0) {
                            size = (s.charCodeAt(0) > 0 && s.charCodeAt(0) < 128) ? 8 : 4;
                            if (s.length > size + 2) s = s.substr(0, size) + '...';
                            s = (s == '黑色星期五') ? s.fontcolor('black') : s.fontcolor('#43a0f2');
                        } else { //廿四节气
                            s = cld[sD].solarTerms;
                            if (s.length > 0) s = s.fontcolor('green');
                        }
                    }
                    if (cld[sD].solarTerms == '清明') s = '清明节'.fontcolor('#fb6b5b');
                    if (cld[sD].solarTerms == '芒种') s = '芒种节'.fontcolor('#fb6b5b');
                    if (cld[sD].solarTerms == '夏至') s = '夏至节'.fontcolor('#fb6b5b');
                    if (cld[sD].solarTerms == '冬至') s = '冬至节'.fontcolor('#fb6b5b');
            ...
            for (i = 0; i < 12; i++) {
                ...
                if ((SJT).substring(i * 3, i * 3 + 1) == 1) SJObj.style.color = "#fb6b5b";
        ...
        function changeCld() {
            ...
            switch (m) {
                case 0:
                    ST.innerHTML = '【 ' + STA[0] + kgm + STA[1] + ' 】';
                    break;
                case 1:
                    ST.innerHTML = '【 ' + STA[1] + kgm + STA[2] + ' 】';
                    break;
                case 2:
                    ST.innerHTML = '【 ' + STA[2] + kgm + STA[3] + ' 】';
                    break;
                case 3:
                    ST.innerHTML = '【 ' + STA[3] + kgm + STA[4] + ' 】';
                    break;
                case 4:
                    ST.innerHTML = '【 ' + STA[4] + kgm + STA[5] + ' 】';
                    break;
                case 5:
                    ST.innerHTML = '【 ' + STA[5] + kgm + STA[6] + ' 】';
                    break;
                case 6:
                    ST.innerHTML = '【 ' + STA[6] + kgm + STA[7] + ' 】';
                    break;
                case 7:
                    ST.innerHTML = '【 ' + STA[7] + kgm + STA[8] + ' 】';
                    break;
                case 8:
                    ST.innerHTML = '【 ' + STA[8] + kgm + STA[9] + ' 】';
                    break;
                case 9:
                    ST.innerHTML = '【 ' + STA[9] + kgm + STA[10] + ' 】';
                    break;
                case 10:
                    ST.innerHTML = '【 ' + STA[10] + kgm + STA[11] + ' 】';
                    break;
                default:
                    ST.innerHTML = '【 ' + STA[11] + kgm + STA[0] + ' 】';
            }
        }
        ...
        var tD = Today.getDate();
         ...
         //时间
        setInterval(function() {
            with(new Date) document.getElementById("tim").innerHTML = '<font style="color:#fb6b5b">【现在时间】</font> ' + (getHours() < 10 ? ('0' + getHours()) : getHours()) + ':' + (getMinutes() < 10 ? ('0' + getMinutes()) : getMinutes()) + ':' + (getSeconds() < 10 ? ('0' + getSeconds()) : getSeconds()) + '（' + '子丑丑寅寅卯卯辰辰巳巳午午未未申申酉酉戌戌亥亥子'.charAt(getHours()) + '时' + (getHours() % 2 == 0 ? '五六七八' : '一二三四').charAt(parseInt(getMinutes() / 15)) + '刻）'
        }, 1000)
        ...
        function tick() {
            ...
            for (k = 0; k < 12; k++) {
				...
				STGObj.style.padding = 0;
            }
            //时刻
            for (i = 0; i < 17; i++) {
                SJSObj = eval('SJS' + i);
                if (i == 0) SJSObj.innerHTML = sk[j * 17 + i] + '<font style="color:#fb6b5b">吉</font><font style="color:#0000A0">凶</font>：';
            ...
            for (z = 1; z < 17; z++) {
                ...
                if ((z == (tt * 2)) || (z == (tt * 2 - 1))) SJSObj1.style.color = scolor;
                    ...
                    if (SJSObj1.innerHTML.length > 4) SJSObj1.style.color = "#fb6b5b";
                }
            }
        ...
        function stopCount(v) {
            ...
            for (i = 0; i < 17; i++) {
                SJSObj = eval('SJS' + i);
                if (i == 0) SJSObj.innerHTML = sk[v * 17 + i] + '<font style="color:#fb6b5b">吉</font><font style="color:#0000A0">凶</font>：';
                ...
                if (SJSObj.innerHTML.length > 4 && SJSObj.innerHTML.length < 7 && i > 1) SJSObj.style.color = "#fb6b5b";
            }
        }
        //////////////////////////////////////////////////////////////////////////////
        var width = "170";
            ...
            function mOvr(v) {
                ...
                if (sObj.innerHTML != '') {
                    ...
                    if (cld[d].solarTerms == '' && cld[d].solarFestival == '' && cld[d].lunarFestival == '')
                        ...
                        festival = '<TABLE style="width:100%;background:#ee952d" CELLPADDING=2 CELLSPACING=0><tr><td><font style="color:#fff">' + cld[d].solarTerms + '</font>&nbsp;<font style="color:#fff">' + cld[d].solarFestival + '</font>&nbsp;<font style="color:#fff">' + cld[d].lunarFestival + '</font></td></tr></TABLE>';
                    //年月日星期
                    ...
                    if (days < 0) days = '距离今天&nbsp;&nbsp;已过&nbsp;<font style="color:#fff;font-family:Arial">' + (0 - days) + '</font>&nbsp;&nbsp;天';
                    if (days > 0) days = '距离今天&nbsp;&nbsp;还有&nbsp;<font style="color:#fff;font-family:Arial">' + days + '</font>&nbsp;&nbsp;天';
                    if (days == 0) days = '距离今天&nbsp;&nbsp;<font style="color:#fff;font-family:Arial">' + days + '</font>&nbsp;&nbsp;天';
                    //第几周
                    ...
                    //浮动框输出
                    s = '<TABLE style="width:200px;background:#0063a6"><tr><td><TABLE style="width:100%;"><tr><td style="text-align:right;"><font style="color:#fff">' + nymdw + '</font><br><font style="color:#fff">' + Lunard + '&nbsp;' + zhou + '</font><br><font style="color:yellow">' + cYMD + '</font></td></tr></TABLE>' + festival + '<TABLE CELLPADDING="2" CELLSPACING="0" style="width:100%;background:#fff;"><tr><td>' + jy + '</td></tr></TABLE><TABLE CELLPADDING="2" CELLSPACING="0" style="background:#ee952d;width:100%;"><tr><td style="color:#fff;text-align:center;">' + days + '</td></tr></TABLE></td></tr></TABLE>';
                    document.all["detail"].innerHTML = s;
                    
                    if (snow == 0) {
                    	dStyle.visibility = "visible";
                        dStyle.left = (gObj.offsetLeft+46)+ "px";
                        dStyle.top = (gObj.offsetTop+165+gObj.offsetHeight) + "px";
                        snow = 1;
                    }
                    //日辰吉凶
                    for (i = 0; i < 12; i++) {
                    ...
                    for (i = 0; i < 12; i++) {
                        ...
                        if ((cld[d].sgz).substring(i * 3, i * 3 + 1) == 1) SJObj.style.color = "#fb6b5b";
                    ...
                    rdate.innerHTML = '<font style="font-size:48px;color:#fff;display:block;font-weight:blod;height:48px;line-height:48px;font-family:Arial Black">' + cld[d].sDay + '</font>';
                    rnlw.innerHTML = Lunard + '&nbsp;' + zhou;
                    rjzn.innerHTML = cYMD;
                    rjryj.innerHTML = '<table style="width:100%;"><tr><td rowspan="3" style="width:30px;text-align:center;background:#ee952d;border-top:none;"><font style="color:#fff">节<br><br>日</font></td><td style="height:36px;background:#ee952d;border-top:none;"><font style="color:#fff">&nbsp;&nbsp;' + cld[d].solarFestival + '</font></td></tr><tr><td style="height:22px;background:#ee952d;border-top:none;"><font style="color:#fff;">&nbsp;&nbsp;' + cld[d].lunarFestival + '</font></td></tr><tr><td style="height:22px;background:#ee952d;border-top:none;"><font style="color:#fff">&nbsp;&nbsp;' + cld[d].solarTerms + '</font></td></tr></table>';
                    rjy.innerHTML = jy;
                }
            }
