...
<body>
   <section class="scrollable padder jcGOA-section" id="scrollable">
     ...
     <section class="panel tab-content">
     		...
     		<%--领导批注权限限制 --%>
     		<%--token性能优化<input type="hidden" id="token" name="token" value="0" /> --%>
                 ...
                 <table class="table table-td-striped">
                     <tbody>
                         ...
                         <tr>
                             ...
                             <td>
	                            <c:choose>
                             		<c:when test="${workTask.remindType eq '1'}">短信</c:when>
                             ...
                             <td>
			                    <c:choose>
                             		<c:when test="${workTask.remind eq null}">不提醒</c:when>
                             		<c:otherwise>
	                             	    <input type="hidden" id="remind" name="remind"/>
				                        <a id="remindSet" name="remindSet"  class="a-icon i-new" href="#" role="button" data-toggle="modal">提醒设置</a> 
                             		</c:otherwise>
                             	</c:choose>
                             </td>
                              --%>
