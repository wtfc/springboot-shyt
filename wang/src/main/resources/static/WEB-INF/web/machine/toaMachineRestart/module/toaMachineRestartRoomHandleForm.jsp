...
<section class="scrollable padder jcGOA-section" id="scrollable"> 
	...
	<section class="panel clearfix" >
		<form class="table-wrap  m-20-auto" id="toaMachineRestartRoomHandleForm">
			<h3 class=" tc" style="font-size:20px;margin:0;border:0;">重启操作 </h3>
				...
				<table class="table table-td-striped">
					<tbody>
						...
						<tr>
							<td><span class="required">*</span>客户联系人</td>
							<td>
								<div id="contact"></div>
							</td>
							<td><span class="required">*</span>客户联系方式</td>
							<td>
					...
					<section class="clearfix" id="footer_height">
						<section class="form-btn fl m-l">
							<a class="btn dark"  onclick="toaMachineRestartRoomHandleModule.saveOrModifyRoomHandle(true)">提  交</a>
						</section>
					</section>
				</form>
			</section>
			<section class="panel tab-content">
				<form id="toaMachineRestartExchange">
					<div class="table-wrap form-table" id="exchange">
						...
						<button id="exchangeSubmit" class="btn" onclick="toaMachineRestartRoomHandleModule.restartExchange(true)" type="button" class="btn">提 交</button>
					</div>
				</form>
			</section>
		</section>
...
$(document).ready(function(){
	var ids=(${Id});
	if(ids!=null&&ids!=""){
		toaMachineRestartRoomHandleModule.get(ids);
	}
});
</script>
</c:if>
<%@ include file="/WEB-INF/web/include/foot.jsp"%>
<script src="${sysPath}/js/com/machine/toaMachineRestart/module/toaMachineRestartRoomHandleForm.js" type="text/javascript"></script>
