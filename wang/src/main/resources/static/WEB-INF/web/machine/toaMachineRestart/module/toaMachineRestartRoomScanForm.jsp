...
<section class="scrollable padder jcGOA-section" id="scrollable"> 
	...
	<section class="panel clearfix" >
		<form class="table-wrap  m-20-auto" id="toaMachineRestartRoomScanForm">
				...
				<table class="table table-td-striped">
					<tbody>
						...
						<tr>
							<td>到场时间</td>
							<td>
								<!-- <input type="text" data-date-format="yyyy-MM-dd HH:mm:ss"data-pick-time="true" class="datepicker-input" style="width:100%;"id="warnDate" name="warnDate"  /> -->
							</td>
						...
						<tr>
							<td>扫描码</td>
							<td>
								<input type="text" style="width:100%;" id="scanCode" name="scanCode">
							</td>
							<td>协助处理</td>
							<td></td>
						</tr>
					...
					<section class="clearfix" id="footer_height">
						<section class="form-btn fl m-l">
							<a class="btn dark"  onclick="toaMachineRestartRoomScanModule.saveOrModifyRoomScan(true)">提  交</a>
						</section>
					</section>
				</form>
			</section>
			<section class="panel tab-content">
				<form id="toaMachineRestartExchange">
					<div class="table-wrap form-table" id="exchange">
						...
						<button id="exchangeSubmit" class="btn" onclick="toaMachineRestartRoomScanModule.restartExchange(true)" type="button" class="btn">提 交</button>
					</div>
				</form>
			</section>
		</section>
...
$(document).ready(function(){
	var ids=(${Id});
	if(ids!=null&&ids!=""){
		toaMachineRestartRoomScanModule.get(ids);
	}
});
</script>
</c:if>
<%@ include file="/WEB-INF/web/include/foot.jsp"%>
<script src="${sysPath}/js/com/machine/toaMachineRestart/module/toaMachineRestartRoomScanForm.js" type="text/javascript"></script>
