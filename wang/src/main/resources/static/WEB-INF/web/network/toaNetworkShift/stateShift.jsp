	        ...
	        <table class="table table-td-striped">
	            <tbody>
		            ...
		            <td style="width:10%;" class=" b-green-dark b-tc">执行人</td>
						...
						<td>
							<input type="text" style="width:100%;"id="connectPeople" name="connectPeople" value="${name}"/>
						</td>
					</tr>
	            </tbody>
	        </table>
...
//设置每行按钮
 function oTableSetButtones (source) {
	...
	var del="";
	if(source.extStr1!=1){
		del = "<a class=\"a-icon i-remove\" href=\"#\" onclick=\"toaNetworkShift.stateToaNetworkShift("+ source.id+")\">交接确认</a>";
	}
	return read+del;
}; 
</script>
...
<script src='${sysPath}/js/com/network/toaNetworkShift/stateShift.js'></script>
