	        ...
	        <table class="table table-td-striped">
	           <tbody>
		            <tr>
						<td>项目名称</td>
						<td>
							<input hidden="hidden" id="status" name = "status" value="1"/>
...
//设置每行按钮
 function oTableSetButtones (source) {
	...
	var del = "<a class=\"a-icon i-new m-r-xs\" href=\"#\" onclick=\"monitor.updatemonitor("+ source.id+")\">确认完成</a>";
	return read+del ;
}; 
</script>
...
<script src='${sysPath}/js/com/oa/project/monitor/monitorSj.js'></script>
