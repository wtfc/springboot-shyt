        ...
        <table class="table table-td-striped">
            <tbody>
            	<tr>
                   ...
                   <td style="width:40%;">
               			<div id="applierTree"></div>
               	   </td>
               	   <td class="w140">申请部门</td>
	               <td>
	               		<div id="deptTree"></div>
	               </td>
           		</tr>
                <tr>
	               ...
	               <td>
	               		<div class="input-group w-p100">
							<input type="text" id="createDateBegin" name="createDateBegin" class="datepicker-input" data-date-format="yyyy-MM-dd" data-ref-obj="#createDate_ lt">
							<div class="input-group-btn w30"> -</div>
							<input type="text" id="createDateEnd" name="createDateEnd" class="datepicker-input" data-date-format="yyyy-MM-dd" data-ref-obj="#createDate gt">
						</div>
	               </td>
           		</tr>
          		<tr>
...
<section class="panel clearfix" id="IP-edit">
    ...
    <div class="table-wrap">
        <table class="table table-striped tab_height" id="reqTable">
            <thead>
                <tr>
                	<th>申请类别</th>
...
<script src="${sysPath}/js/ext/pur/req/reqList.js" type="text/javascript"></script>
