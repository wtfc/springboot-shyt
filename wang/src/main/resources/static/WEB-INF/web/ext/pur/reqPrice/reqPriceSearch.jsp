     ...
     <section class="tree-right">
         ...
         <section class="panel m-t-md">
             ...
             <div class="table-wrap input-default">
                 <table class="table table-striped table-bordered b-light first-td-tc tab_height" id="reqPriceSearchTable">
                     <thead>
						<tr>
							<th class="w170">操作</th>
						</tr>
...
<script src='${sysPath}/js/com/pur/reqPrice/reqPriceSearch.js'></script>
