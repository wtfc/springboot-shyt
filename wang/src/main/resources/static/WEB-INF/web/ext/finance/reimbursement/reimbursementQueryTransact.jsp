...
<script src="${sysPath}/js/ext/finance/reimbursementQueryTransact.js" type="text/javascript"></script>
...
<div class="search-line hide">
        <form class="table-wrap form-table" id="sendQueryTransactListForm">
            <table class="table table-td-striped">
                <tbody>
                    <tr>
                        <td class="w140">报销人员</td>
                        <td style="width:40%">
                        	<div id="queryRePeoTree"></div>
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="width:40%">
<!-- 	                        <select name="flowStatusForQuery" id="flowStatusForQuery">
            ...
            <section class="form-btn m-b-lg">
                <button class="btn dark query-jump" type="button" id="querySendQueryTransact">查 询</button>
    ...
    <!--end 查询条件-->
    <!--start 查询结果-->
    <section class="panel clearfix" id="sendQueryTransact-list">
        <h2 class="panel-heading clearfix">查询结果</h2>
        <div class="table-wrap">
            <table class="table table-striped tab_height" id="sendQueryTransactTable">
                <thead>
                    <tr>
                        <th class="w170">编号</th>
                        <th class="w100">报销人员</th>
                        <th class="w170">报销部门</th>
