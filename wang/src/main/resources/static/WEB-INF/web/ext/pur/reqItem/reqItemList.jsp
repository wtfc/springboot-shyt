...
<h2 class="panel-heading clearfix">采购申请项目表</h2>
<div class="table-wrap">
	...
	<table class="table table-striped tab_height first-td-tc" id="reqItemTable">
		<thead>
			<tr>
...
<section class="clearfix" id="footer_height">
 ...
 <script src='${sysPath}/js/com/pur/reqItem/reqItemList.js'></script>
