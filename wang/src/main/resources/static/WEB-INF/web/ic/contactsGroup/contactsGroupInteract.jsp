...
<html lang="en">
  <head>
    ...
    <title>联系人分组表，默认常用联系人，最近联系人</title>
...
<script src="<%=basePath%>js/com/ic/contactsGroup/contactsGroupInteract.js"></script>
...
<script src='<%=basePath%>js/com/ic/contactsGroup/contactsGroupInteract.validate.js'></script>
...
<div id="contactsGroupFormDiv" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-header">
	   <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
	   <h3 id="myModalLabel">联系人分组表，默认常用联系人，最近联系人</h3>
	</div>
	<form class="form-horizontal" id="contactsGroupForm">
	...
	<div class="modal-footer">
	    ...
	    <button id="ContactsGroupSubmit" class="btn btn-primary">保存</button>
  </div>
</div>
