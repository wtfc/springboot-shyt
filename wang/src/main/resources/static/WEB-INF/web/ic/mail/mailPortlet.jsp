		...
		<section class="panel m-t-md">
			<div class="table-wrap">
				<section class="email-btn form-btn">
						<button class="btn" type="button" onclick="homeloadmenu()">返回</button>
						...
						<button class="btn" id="topStarButton" type="button" onclick ="mailDetail.setStar(${mail.id},${mail.receiver.folderId},${mail.receiver.id})">星标</button>
						<div class="inline fr">
						<c:choose>
			...
			<header class="email-header table-wrap">
				...
				<!--end 查看往来邮件-->
				<%-- <div class="panel-heading clearfix dropup">
			        <h2 id="mailTitle">${mail.mailTitle }</h2>
				</div> --%>
				<!--start 详细邮件信息-->
					...
					<div class="email-compile table-wrap hide" id="password">
						...
						<tr>
							<td ><label
								...
								<a href="#" class="a-icon i-new m-l-xs"  type="button" id="btnPortalPswOk">确定</a>
							</td>
						</tr>
						</table>						
			...
			<div class="fast-reply-box table-wrap hide">
				...
				<section class="form-btn m-t">
					<a href="javascript:mailDetail.fastreply()" class="btn dark m-r-md" id="btnSend">发 送</a> <a href="javascript:void(0);"
						class="btn close-fast-reply" id="btnCancel">取 消</a> <a href="javascript:mailDetail.replySwitchToWhole();" class="btn dark fr">切换至完整模式</a>
				</section>
			</div>
			<!--end 邮件详细回复-->
			<!--start 邮件快速细回复-->
			<div class="form-table table-wrap">
				<input type="text"  id="fast_reply"  value="可快速回复：" class="fast-reply email-placeholder">
			</div>
			<!--end 邮件快速细回复-->
