...
<script src="<%=basePath%>js/com/smsserver/calls/callsIc.js"></script>
...
<script src='<%=basePath%>js/com/smsserver/calls/callsIc.validate.js'></script>
...
<div id="callsFormDiv" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-header">
	   <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
	   <h3 id="myModalLabel">中间件接到电话之后会将其存入该表</h3>
	</div>
	<form class="form-horizontal" id="callsForm">
	<input type="hidden" id="id" name = "id"  >
		  <div class="control-group">
		     <label class="control-label" for="callDate">电话呼入时间</label>
		     <div class="controls ">
		       <input type="text" id="callDate" name = "callDate" >
		     </div>
		  </div>
		  <div class="control-group">
		     <label class="control-label" for="gatewayId">通道标识，用于标识是哪个通道收到的短信</label>
		     <div class="controls ">
		       <input type="text" id="gatewayId" name = "gatewayId" >
		     </div>
		  </div>
		  <div class="control-group">
		     <label class="control-label" for="callerId">对方号码</label>
		     <div class="controls ">
	...
	<div class="modal-footer">
	    ...
	    <button id="CallsSubmit" class="btn btn-primary">保存</button>
  </div>
</div>
