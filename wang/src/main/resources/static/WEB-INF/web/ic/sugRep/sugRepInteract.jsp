...
<script src="<%=basePath%>js/com/ic/sugRep/sugRepInteract.js"></script>
...
<script src='<%=basePath%>js/com/ic/sugRep/sugRepInteract.validate.js'></script>
...
<div id="sugRepFormDiv" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-header">
	   <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
	   <h3 id="myModalLabel">建议回复表</h3>
	</div>
	<form class="form-horizontal" id="sugRepForm">
	<input type="hidden" id="id" name = "id"  >
		  <div class="control-group">
		     <label class="control-label" for="suggestId">suggestId</label>
		     <div class="controls ">
		       <input type="text" id="suggestId" name = "suggestId" >
		     </div>
		  </div>
		  <div class="control-group">
		     <label class="control-label" for="repContent">回复内容</label>
		     <div class="controls ">
		       <input type="text" id="repContent" name = "repContent" >
		     </div>
		  </div>
		  <div class="control-group">
		     <label class="control-label" for="repTime">回复时间</label>
		     <div class="controls ">
		       <input type="text" id="repTime" name = "repTime" >
		     </div>
		  </div>
		  <div class="control-group">
	...
	<div class="modal-footer">
	    ...
	    <button id="SugRepSubmit" class="btn btn-primary">保存</button>
  </div>
</div>
