        ...
        <header class="header navbar-fixed-top" id="desktop_header">
			<!--            	新start -->
             <div class="navbar-topbar clearfix">
                <h1 class="fl"><a class="navbar-brand">森华易腾CRM系统</a></h1>
                <!-- <i class="fa fa-cross"></i> -->
                
              <div class="m-t-xs fr dropdown text-grey-666" id="dropdownMenu">
                   <!-- onClick="skin()" -->
                   <a onClick="window.open('${sysPath}/help/help.html','_blank','width=1000px,height=600px');return false;" href="#" class="icon-help" >帮助</a>
                    <a href="javascript:void(0)" class="icon-voice" value="on"  id="voiceSwitch"  onclick="turnVoice(this);">声音</a>
                    ...
                    <ul class="dropdown-menu animated fadeInRight" style="min-width: 125px;">
                        <li value="0"><a href="#">蓝色主题</a></li>
                        <li value="1"><a href="#">绿色主题</a></li>
                        <li value="2"><a href="#">三色经典</a></li>
                    </ul>
               </div>
              <section class="userInfo fr clearfix">
                <div class="user-avatar fl">
                	<a href="#" onClick="loadrightmenu('/sys/user/userInfo.action','','/sys/user/userInfo.action')">
                        <img src="<shiro:principal property="photo"/>" height="40"/>
                    </a>
                </div>
                <div class="user-info fl">
                      <div class="clearfix name m-t-xs">
                      		<p class="inter" style="width:170px;margin:0;padding:0;">
                          		<span>欢迎您：<shiro:principal property="displayName"/><shiro:principal property="dutyIdValue"/></span><br/>
                          	</p>
                          	<span> 
								<span href="#" id="onlineCount" style="cursor:pointer;">在线：
