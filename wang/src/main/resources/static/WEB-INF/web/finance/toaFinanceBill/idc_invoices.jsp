...
<div class="padder jcGOA-section" id="scrollable">
		...
		<input type="hidden" id="billMoney" name="billMoney" value="${money}"/>
		...
		<tbody>
			...
			<tr>
			  	<%-- <td style="border-color:white;">本公司开具增值税 ${toaFinanceBill.ticket}（专用/普通）发票。</td> --%>
		...
		<thead align="center" style="font-size:12pt;line-height:1.5;color:black;font-family:宋体" >
		    <tr>
		      ...
		      <td rowspan="2" align="center">资源使用情况</td>
