...
//设置每行按钮
 function oTableSetButtones (source) {
	...
	if(source.state==0||source.state==1){
		...
		del ="<a class=\"a-icon i-remove\" href=\"#\" onclick=\"toaFinanceBill.deleteToaFinanceBill("+ source.id+")\"><i class=\"fa fa-remove\" data-toggle=\"tooltip\" data-placement=\"top\" data-container=\"body\" data-original-title=\"删除\"></i></a>";
	}
		return print+invoice+del;
}; 
</script>
...
<script src='${sysPath}/js/com/finance/toaFinanceBill/jujueBill.js'></script>
