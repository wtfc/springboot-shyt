...
//设置每行按钮
 function oTableSetButtones (source) {
	...
	//return read+del;
	var del = "";
	if(source.place==null||source.place==""){
		del = '<shiro:hasPermission name="user:deleteIncontract"><a class="a-icon i-remove" href="#" onclick="toaContractIncontract.deleteToaContractIncontract('+ source.id+')"><i class="fa fa-remove" data-toggle="tooltip" data-placement="top" data-container="body" data-original-title="删除"></i></a></shiro:hasPermission>';
	}
	...
	read = '<shiro:hasPermission name="user:updateIncontract"><a class="a-icon i-new m-r-xs" href="'+getRootPath()+'/contract/toaContractIncontract/loadForm.action?id='+source.id+'" onclick="">编辑</a></shiro:hasPermission>';
...
excuteExcel.exportExcel = function () {
    var url = getRootPath()+"/contract/toaContractIncontract/exportExcel.action";
...
<script src='${sysPath}/js/com/oa/contract/toaContractIncontract/toaContractIncontract.js'></script>
