...
<script src="${sysPath}/js/com/im/infoAnalysis/infoAnalysisTrend.js" type="text/javascript"></script>
...
<section class="scrollable padder jcGOA-section" id="scrollable">
	...
	<section class="panel m-t-md clearfix">
		...
		<div class="table-wrap">
			<div id="queryInfoAnalysisTrend_div">
			</div>
		</div>
		<div class="table-wrap tab-content">
			<table class=" formTable">
				<tbody id="queryInfoAnalysisTrend_Content">
				</tbody>
			</table>
		</div>
	</section>
