...
<script src="${sysPath}/js/com/im/infoAnalysis/infoAnalysisByColumn.js" type="text/javascript"></script>
...
<section class="scrollable padder jcGOA-section" id="scrollable">
	...
	<section class="panel m-t-md clearfix">
		<form id="infoAnalysisByColumnForm">
		...
		<div class="table-wrap">
			<div id="queryInfoAnalysisByColumn_div">
			</div>
		</div>
		<div class="table-wrap tab-content">
			<table class=" formTable">
				<tbody id="queryInfoAnalysisByColumn_Content">
				</tbody>
			</table>
		</div>
	</section>
