...
function oTableSetButtons(mData,type,full) {
	readBtn = "<a class=\"a-icon i-new m-r-xs\" href=\"#\"  onclick=\"infoMyPortal.infoDetail("+full.id+ ")\">查看详细</a>";
	return readBtn;
};
</script>
<script src="${sysPath}/js/com/im/infoMyPortal.js"></script>

<section class="scrollable padder jcGOA-section" id="scrollable"> 
	<header class="con-header pull-in" id="header_1">
	<h1>我的信息</h1>
	<div class="crumbs">
		<a href="#" onclick="homeloadmenu()">首页</a><i></i>信息管理<i></i>我的信息
	</div>
</header>
	<!--start 查询条件-->
	<section class="panel clearfix search-box search-shrinkage">
		<div class="search-line hide">
		<input type="hidden" name="portalColumnId" id="portalColumnId" value='${portalColumnId}'>
