...
body{margin:8px;font-family:sans-serif;font-size:16px;padding:0 15px;}p{margin:5px 0;}
</style>
<link rel="stylesheet" type="text/css" href="${sysPath}/js/ueditor/themes/iframe.css">
<style id="tablesort">
table.sortEnabled tr.firstRow th,table.sortEnabled tr.firstRow td{padding-right:20px;background-repeat: no-repeat;background-position: center right;   background-image:url(http://172.16.3.179:8080/goa/js/ueditor/themes/default/images/sortable.png);}
</style>
<style id="table">
...
.list-paddingleft-3{padding-left:60px}</style><style id="pagebreak">.pagebreak{display:block;clear:both !important;cursor:default !important;width: 100% !important;margin:0;}</style><style id="pre">pre{margin:.5em 0;padding:.4em .6em;border-radius:8px;background:#f8f8f8;}</style><style id="loading">.loadingclass{display:inline-block;cursor:default;background: url('http://172.16.3.179:8080/goa/js/ueditor/themes/default/images/loading.gif') no-repeat center center transparent;border:1px solid #cccccc;margin-left:1px;height: 22px;width: 22px;}
.loaderrorclass{display:inline-block;cursor:default;background: url('http://172.16.3.179:8080/goa/js/ueditor/themes/default/images/loaderror.png') no-repeat center center transparent;border:1px solid #cccccc;margin-right:1px;height: 22px;width: 22px;}</style><style id="anchor">.anchorclass{background: url('http://172.16.3.179:8080/goa/js/ueditor/themes/default/images/anchor.gif') no-repeat scroll left center transparent;cursor: auto;display: inline-block;height: 16px;width: 15px;}</style>
</head>
<body>
${info.infoContent}
</body>
<script type="text/javascript">
//alert(window.parent.frames["infoContent"].document.body.scrollHeight)
window.onload = function(){ 
	window.parent.restoreViewState();
} 
</script>
</html>