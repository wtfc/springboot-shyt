...
<script src="${sysPath}/js/com/im/infoAnalysis/infoAnalysisBySender.js" type="text/javascript"></script>
...
<section class="scrollable padder jcGOA-section" id="scrollable">
	...
	<section class="panel m-t-md clearfix">
		<form id="infoAnalysisBySenderForm">
		...
		<div class="table-wrap">
			<div id="queryInfoAnalysisBySender_div">
			</div>
		</div>
		<div class="table-wrap tab-content">
			<table class=" formTable">
				<tbody id="queryInfoAnalysisBySender_Content">
				</tbody>
			</table>
		</div>
	</section>
