...
<script src="${sysPath}/js/com/oa/archive/audithis.js"></script>
...
<div class="search-line hide">
   <form id="audihhisForm" class="table-wrap form-table">
       <table class="table table-td-striped">
           <tbody>
               <tr>
                   <td class="w50" style ="width:240px;">操作人员</td>
                   <td class="w50" style ="width:500px;">
                    	<div id="userId"></div>
                   </td>
                   <td class="w50" style ="width:200px;">操作类型</td>
                   <td class="w50" style ="width:500px;">
               ...
               <tr>
					<td class="w50" style ="width:100px;">名称</td>
                   <td class="w50">
               ...
               <tr>
                   <td class="w50">操作IP</td>
                   <td class="w50">
				   		<input id="ip" name="ip" type="text">
					</td>
                   <td class="w50">操作时间</td>
                   <td class="w50">
