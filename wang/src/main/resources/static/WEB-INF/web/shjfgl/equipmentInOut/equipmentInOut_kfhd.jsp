...
//设置每行按钮
 function oTableSetButtones (source) {
	...
	var del="";
	if(source.status==1){
	 edit = '<shiro:hasPermission name="user:operate"><a class="a-icon i-edit m-r-xs" href="#" onclick="equipmentInOut.operateEquipmentInOut('+source.id+')" role="button" data-toggle="modal"><i class="fa fa-edit2" data-toggle="tooltip" data-placement="top" data-container="body" data-original-title="开始操作"></i></a></shiro:hasPermission>';
...
<script src='${sysPath}/js/com/shjfgl/equipmentInOut/equipmentInOut_kfhd.js'></script>
