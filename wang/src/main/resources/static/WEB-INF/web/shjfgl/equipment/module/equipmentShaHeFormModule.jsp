...
<div class="modal fade panel" id="myModal-edit" aria-hidden="false">
	<div class="modal-dialog w900">
		<form class="table-wrap form-table" id="equipmentShaHeForm">
									...
									<table class="table table-td-striped">
										<tbody>
											<tr>
                                               ...
                                               <td colspan="3">
                                               		<a onclick="equipmentShaHeModule.closeWin();" type="button" href="#new-agency" role="button" data-toggle="modal"><input type="text" id="clientName" name="clientName" style="width: 100%;" readonly/></a>
						...
						<tbody>
							<tr>
								...
								<td>
				            		...
				            		<button class="btn dark" type="button" onclick="equipmentShaHeModule.getWorkTask()">查 询</button>
				           		 	<button class="btn" type="button" onclick="equipmentShaHeModule.queryReset()">重 置</button>
								</td>
							</tr>
						</tbody>
					</table>
				 ...
				 <section class="panel-tab-con">
                     <div class="tab-content">
                             ...
                             <form class="table-wrap">
                                 <table class="table table-striped frist-td-tc" id="equipmentShaHeTaskTable">
                                     <thead>
                                         <th class="w46">请选择</th>
                                         <th>公司名称</th>
                                     </thead>
...
<script src="${sysPath}/js/com/shjfgl/equipment/module/equipmentShaHeModule.js" type="text/javascript"></script>
<script src="${sysPath}/js/com/shjfgl/equipment/equipmentShaHe.validate.js" type="text/javascript"></script>