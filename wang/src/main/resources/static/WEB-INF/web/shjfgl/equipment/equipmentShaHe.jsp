...
<section class="panel clearfix search-box search-shrinkage">
    <div class="search-line hide">
    	<form class="table-wrap form-table" id="equipmentShaHeQueryForm" name="equipmentShaHeQueryForm">
	        <table class="table table-td-striped">
	            <tbody>
					...
					<tr>
						<td>机房名称</td>
						<td>
							<input type="text" id="contact" name="contact" value="沙河机房" readonly/>
                      </td>
                      <td>管理网IP</td>
				     <td>
...
//设置每行按钮
 function oTableSetButtones (source) {
	var buttonStr = "";
	var see = "<a class=\"a-icon i-new m-r-xs\" href=\"#\" onclick=\"equipmentShaHe.get("+ source.id+")\" role=\"button\" data-toggle=\"modal\" style=\"padding:1px 4px;\">查看</a>";
	var edit = "<a class=\"a-icon i-edit m-r-xs\" href=\"#myModal-edit\" onclick=\"equipmentShaHe.loadModuleForUpdate("+ source.id+ ")\" role=\"button\" data-toggle=\"modal\" style=\"padding:1px 4px;\">编辑</a>";
	var del = '<shiro:hasPermission name="user:deleteEquipment"><a class="a-icon i-remove" href="#" onclick="equipmentShaHe.deleteEquipment('+ source.id+')" style="padding:1px 4px;">删除</a></shiro:hasPermission>';
...
<div class="table-wrap">
	...
	<table class="table table-striped tab_height first-td-tc" id="equipmentShaHeTable">
		<thead>
			<tr>
...
<div class="modal fade panel" id="myModal" aria-hidden="false">
	<div class="modal-dialog w900">
		<form class="table-wrap form-table" id="equipmentShaHeSeeForm">
...
<script src='${sysPath}/js/com/shjfgl/equipment/equipmentShaHe.js'></script>
