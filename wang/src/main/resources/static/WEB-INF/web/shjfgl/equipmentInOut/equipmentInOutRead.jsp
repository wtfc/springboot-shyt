...
//设置每行按钮
 function oTableSetButtones (source) {
	var read = "<a class=\"a-icon i-new m-r-xs\" href=\""+getRootPath()+"/machine/equipmentInOut/manage.action?id="+source.id+"&status=3\" onclick=\"\">查看详细</a>";
	return read ;
}; 
</script>
...
<script src='${sysPath}/js/com/shjfgl/equipmentInOut/equipmentInOutRead.js'></script>
