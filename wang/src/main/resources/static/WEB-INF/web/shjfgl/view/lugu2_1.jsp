...
<style>
	*{
	...
	#lugu2_1 tbody tr,#lugu2_1 tbody tr td{
...
<h1 class="panel-heading clearfix" style="text-align: center;font-size: 25px">鲁谷2-1机房平面图</h1>
<div >
...
<div class="main">
<table class="table table-striped tab_height first-td-tc" id="lugu2_1">
<tbody>
	<!-- A -->
	<tr>
		<td >机柜详情</td>
		...
		<c:forEach items="${dList}" var="m">
			<c:if test="${m.machinaNumber eq 'A24'}">  
	     		   style="background-color:${m.type};" onClick="add('2-1','${ m.machinaNumber}')" data-original-title="机柜编号：${ m.machinaNumber};是否开通：${m.isOpen} ; 机柜容量：${m.valume} ;设备数量：${m.num} ;"
			</c:if>
		</c:forEach>
		>A24</button></td>
		...
		>A14</button></td>
		<td rowspan="44" style="background: #00CC00; border: none;">通道</td>
	...
	<tr>
		...
		>C23</button></td>
		<td style="background: #0CC;"><button id="C20" type="button" class="btn wh"data-toggle="tooltip" data-placement="top" data-container="body"
		<c:forEach items="${dList}" var="m">
