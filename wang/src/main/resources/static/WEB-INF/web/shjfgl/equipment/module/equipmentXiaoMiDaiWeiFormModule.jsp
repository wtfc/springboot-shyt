...
<div class="modal fade panel" id="myModal-edit" aria-hidden="false">
	<div class="modal-dialog w900">
		<form class="table-wrap form-table" id="equipmentXiaoMiDaiWeiForm">
									...
									<table class="table table-td-striped">
										<tbody>
											<tr>
                                               ...
                                               <td colspan="3">
                                               		<a onclick="equipmentXiaoMiDaiWeiModule.closeWin();" type="button" href="#new-agency" role="button" data-toggle="modal"><input type="text" id="clientName" name="clientName" style="width: 100%;" readonly/></a>
                                           ...
                                           <tr>
                                               ...
                                               <td>设备配置</td>
                                               <td><textarea  id="device" name = "device"></textarea>
                                           </tr>
                                           <tr>
                                               <td>备 注</td>
						...
						<tbody>
							<tr>
								...
								<td>
				            		...
				            		<button class="btn dark" type="button" onclick="equipmentXiaoMiDaiWeiModule.getWorkTask()">查 询</button>
				           		 	<button class="btn" type="button" onclick="equipmentXiaoMiDaiWeiModule.queryReset()">重 置</button>
								</td>
							</tr>
						</tbody>
					</table>
				 ...
				 <section class="panel-tab-con">
                     <div class="tab-content">
                             ...
                             <form class="table-wrap">
                                 <table class="table table-striped frist-td-tc" id="equipmentXiaoMiDaiWeiTaskTable">
                                     <thead>
                                         <th class="w46">请选择</th>
                                         <th>公司名称</th>
                                     </thead>
...
<script src="${sysPath}/js/com/shjfgl/equipment/module/equipmentXiaoMiDaiWeiModule.js" type="text/javascript"></script>
<script src="${sysPath}/js/com/shjfgl/equipment/equipmentXiaoMiDaiWei.validate.js" type="text/javascript"></script>