...
public class MailRecordValidator implements Validator{
	...
	public boolean supports(Class<?> arg0) {
		return MailRecord.class.equals(arg0);
	}
	...
	public void validate(Object arg0, Errors arg1) {
		MailRecord v =  (MailRecord)arg0;
		if(v.getReceiveMail()!=null&&v.getReceiveMail().length()>128){
			arg1.reject("receiveMail", "ReceiveMail is too long");
		}
