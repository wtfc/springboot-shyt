...
public class MailFolderValidator implements Validator{
	...
	public boolean supports(Class<?> arg0) {
		return MailFolder.class.equals(arg0);
	}
	...
	public void validate(Object arg0, Errors arg1) {
		MailFolder v =  (MailFolder)arg0;
			if(v.getFolderName()!=null&&v.getFolderName().length()>200){
				arg1.reject("folderName", MessageUtils.getMessage("JC_SYS_011", new Object[]{"200"}));
			}
