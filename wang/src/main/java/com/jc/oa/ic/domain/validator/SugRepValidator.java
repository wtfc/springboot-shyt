...
public class SugRepValidator implements Validator{
	...
	public boolean supports(Class<?> arg0) {
		return SugRep.class.equals(arg0);
	}
	...
	public void validate(Object arg0, Errors arg1) {
		SugRep v =  (SugRep)arg0;
		if(v.getRepContent()!=null&&v.getRepContent().length()>400){
			arg1.reject("repContent", "RepContent is too long");
		}
