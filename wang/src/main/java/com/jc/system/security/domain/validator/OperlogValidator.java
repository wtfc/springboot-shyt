...
public class OperlogValidator implements Validator{
	...
	public boolean supports(Class<?> arg0) {
		return Operlog.class.equals(arg0);
	}
	...
	public void validate(Object arg0, Errors arg1) {
		...
		if(v.getIsAdmin()!=null&&v.getIsAdmin().length()>1){
			arg1.reject("isAdmin", "IsAdmin is too long");
		}
		if(v.getOperDesc()!=null&&v.getOperDesc().length()>2000){
			arg1.reject("operDesc", "OperDesc is too long");
		}
		if(v.getFunName()!=null&&v.getFunName().length()>200){
			arg1.reject("funName", "FunName is too long");
		}
	}
}
